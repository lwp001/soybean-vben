...
declare namespace AuthRoute {
  ...
  interface Meta {
    ...
    i18nTitle?: import('@/router/routes/schema').I18nKey;
  ...
  //   isHidden?: boolean;
  //   meta: Meta;
  //   component?: import('vue-router').RouteComponent | Common.Lazy<import('vue-router').RouteComponent> | string;
  //   children?: RouteList;
  // }
  ...
  type RouteType = {
    ...
    name: string;
    /** 路由路径 即组件路径
     * eg.: dashboard/analysis = views/dashboard/analysis/index.vue
     */
    path: string;
    /** 路由重定向 */
    redirect?: string;
  ...
  // type RouteType = import('vue-router').RouteRecordRaw & RouteItem;

  // type RouteType = RouteItem &
  //   Omit<import('vue-router').RouteRecordRaw, 'name' | 'path' | 'redirect' | 'component' | 'children' | 'meta'>;

  type RouteList = Array<RouteType>;
  /** 前端导入的路由模块 */
